...
namespace TrainTravel.API.Migrations
{
    ...
    [Migration("20240222162150_converting halttime")]
    partial class convertinghalttime
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "616c65b6-6985-4ff8-862a-b4d95a092947",
                            ConcurrencyStamp = "616c65b6-6985-4ff8-862a-b4d95a092947",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "a1dfa24d-e4d1-4664-89e9-26fdaa7e3271",
                            ConcurrencyStamp = "a1dfa24d-e4d1-4664-89e9-26fdaa7e3271",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("TrainTravel.API.Model.Domain.BookingsData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("ArrivalDayCount")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("DestinationHaltTime")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("TrainTravel.API.Model.Domain.TrainTravelUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TrainTravel.API.Model.Domain.TrainTravelUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TrainTravel.API.Model.Domain.BookingsData", b =>
                {
                    b.HasOne("TrainTravel.API.Model.Domain.TrainTravelUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TrainTravel.API.Model.Domain.TrainTimeTableData", b =>
                {
                    b.HasOne("TrainTravel.API.Model.Domain.TrainInfoData", "TrainInfoData")
                        .WithMany()
                        .HasForeignKey("trainNumber")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TrainInfoData");
                });
